...
import {clearItems} from "../businessStore/Slices/CartSlice";
...
const Cart = () => {
    ...
    const totalCount = items.reduce((sum, items) => {
            ...
            <div className="cart">
                <div className="cart__top">
                    ...
                    <div className="cart__clear">
                        ...
                        <span onClick={onClickClear}>Очистить корзину</span></div>
                </div>
                <div className="content__items">
                    {
                        items.map((pizzas) => {
                            return <CartItems key={pizzas.id} {...pizzas}/>
                        })
                    }
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всего пицц: <b>{totalCount} шт.</b> </span><span> Сумма заказа: <b>1935 ₽</b> </span></div>
                    <div className="cart__bottom-buttons"><Link to="/" className="button button--outline button--add go-back-btn"
                                                             href="/">
